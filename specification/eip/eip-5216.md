...
This specification defines standard functions for approving amounts of an [ERC-1155](./eip-1155.md).
...
The [ERC-20](./eip-20.md) standard name patterns, were used to simplify the understanding of how the interface works due to similarity with how [ERC-20](./eip-20.md) works with approvals. This decision was made after been discussed at [Ethereum Magicians forum](https://ethereum-magicians.org/t/working-draft-new-extension-for-erc1155).
